...
if __name__ == "__main__":
    ...
    PARAMS = VerlParams(
        ...
        max_steps=4000,
        output_dir="/workspace/15sep_5e6_lr_big_batch_fixed_data_less_clip",
        hub_repo_id="thejaminator/15sep_5e6_lr_big_batch_fixed_data_less_clip",  # Updated with "_verl" suffix
