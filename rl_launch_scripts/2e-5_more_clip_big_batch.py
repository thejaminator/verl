...
if __name__ == "__main__":
    ...
    PARAMS = VerlParams(
        ...
        max_train_samples=6000,  # per file
        ...
        max_steps=4000,
        output_dir="/workspace/12sep_grp16_2e5_lr_big_batch",
        ...
        push_to_hub=True,
        hub_repo_id="thejaminator/12sep_grp16_2e5_lr_big_batch",  # Updated with "_verl" suffix
