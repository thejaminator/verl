...
if __name__ == "__main__":
    ...
    PARAMS = VerlParams(
        ...
        warmup_steps=5,
        learning_rate=4e-5,  # Increased by order of magnitude for LoRA (was 5e-6)
