...
if __name__ == "__main__":
    ...
    PARAMS = VerlParams(
        ...
        grad_clip=0.1,  # because we don't scale by std.dev, our gradients are much smaller
        ...
        max_steps=4000,
        learning_rate=4e-5,
        output_dir="/workspace/12sep_grp16_5e5_lr_no_std_dev_big_grp",
        hub_repo_id="thejaminator/12sep_grp16_5e5_lr_no_std_dev_big_grp",
