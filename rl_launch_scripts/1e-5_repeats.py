...
if __name__ == "__main__":
    ...
    PARAMS = VerlParams(
        ...
        max_steps=4000,
        output_dir="/workspace/12sep_grp16_1e5_lr_repeats",
        ...
        push_to_hub=True,
        hub_repo_id="thejaminator/12sep_grp16_1e5_lr_repeats",  # Updated with "_verl" suffix
