...
if __name__ == "__main__":
    ...
    PARAMS = VerlParams(
        ...
        train_path=[
            "data/qwen_hard_negatives_20000_24000_layer_percent_25.jsonl",
            "data/qwen_hard_negatives_20000_24000_layer_percent_50.jsonl",
        ...
        max_train_samples=16_000,  # per file
        use_feature_vector=True,
        mini_batches=8,
        split_into_grad_accum=32,
        ...
        clip_ratio=0.2,
        ppo_epochs=2,
        use_kl_loss=False,  # For this run I didn't use kl loss
        ...
        max_steps=4000,
        output_dir="/workspace/15sep_1e5_lr_mini_batch",
        hub_repo_id="thejaminator/15sep_1e5_lr_mini_batch",
