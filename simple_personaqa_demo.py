...
prompts = [
    ...
    "What is the favorite sport in this text?",
...
# ACTIVE_LORA_PATH = "model_lora/Qwen3-8B-shuffled"
ACTIVE_LORA_PATH = "model_lora/Qwen3-8B-shuffled_3_epochs"
